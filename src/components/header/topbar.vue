    ...
    <ul class="secondary">
      ...
      <li class="-item" @click="openDialog">
        ...
        >
          ...
          >
            <path
              fill="#848d95"
              d="M15.19 1H4.63c-.85 0-1.6.54-1.85 1.35L0 10.79V15c0 1.1.9 2 2 2h16a2 2 0 0 0 2-2v-4.21l-2.87-8.44A2 2 0 0 0 15.19 1zm-.28 10l-2 2h-6l-2-2H1.96L4.4 3.68A1 1 0 0 1 5.35 3h9.12a1 1 0 0 1 .95.68L17.86 11h-2.95z"
            ></path>
          </svg>

          <span
            class="indicator-badge js-unread-count _important"
            style="display: none"
          ></span>
        </a>
      </li>
      ...
      <li class="-item">
        ...
        >
          ...
          <span
            class="indicator-badge js-unread-count _positive"
            style="display: none"
          ></span>
        </a>
      </li>
      ...
      <li class="-item">
        <a
          ...
          title="A list of all 174 Stack Exchange sites"
        >
          <svg
            aria-hidden="true"
          ...
          >
            <path
              fill="#848d95"
              d="M1 13c0 1.1.9 2 2 2h8v3l3-3h1a2 2 0 0 0 2-2v-2H1v2zM15 1H3a2 2 0 0 0-2 2v2h16V3a2 2 0 0 0-2-2zM1 6h16v4H1V6z"
            ></path>
          </svg>
        </a>
      </li>
      <li class="-ctas">
        <a
          v-if="isLogin === false"
          href="javascript:void(0)"
          class="login s-btn btn-topbar-clear py8"
          rel="nofollow"
          @click="goLogin"
          >Log In</a
        >
        <a
          v-if="isLogin === false"
          href="javascript:void(0)"
          class="sign-up s-btn s-btn__primary py8 btn-topbar-primary"
          rel="nofollow"
          @click="goSignUp"
          >Sign Up</a
        >
  ...
  methods: {
    ...
    focus() {
      ...
      document.querySelector(".input-search").style.border =
        "1px solid #1997fc";
      document.querySelector(".input-search").style.boxShadow =
        "inset 0 2px 2px #fafafb, 0 0 5px rgba(0,199,204,0.4);";
    },
    LogOut() {
...
.top-bar .secondary .-item .-link {
  ...
  transition: background-color cubic-bezier(0.165, 0.84, 0.44, 1) 0.25s,
    color cubic-bezier(0.165, 0.84, 0.44, 1) 0.25s;
}
.secondary {
  height: 100%;
  display: flex;
